...
% Percorso completo per i salvataggi
output_dir = 'C:\Users\lenovo GAME\Desktop\Homework_4';
...
%% --- POSITION ---
fig1 = figure('Renderer', 'painters', 'Position', [100 100 1000 400]);
...
exportgraphics(fig1, fullfile('plot_ex3', 'position.pdf'));

%% --- VELOCITY ---
fig2 = figure('Renderer', 'painters', 'Position', [100 100 1000 400]);
...
exportgraphics(fig2, fullfile('plot_ex3', 'velocity.pdf'));

%% --- ANGULAR VELOCITY ---
fig3 = figure('Renderer', 'painters', 'Position', [100 100 1000 400]);
...
legend({'$\omega_x$', '$\omega_y$', '$\omega_z$', ...
       ...
       'Interpreter', 'latex', 'FontSize', 12, 'Location', 'northeast');
exportgraphics(fig3, fullfile('plot_ex3', 'angular_velocity.pdf'));

%% --- CONTROL FORCES (Fz) ---
fig4 = figure('Renderer', 'painters', 'Position', [100 100 1000 400]);
plot(t2, U2(:,3), 'r', t2, U2(:,6), 'g', t2, U2(:,9), 'b', t2, U2(:,12), 'k', ...
     t, Ud(:,3), 'r--', t, Ud(:,6), 'g--', t, Ud(:,9), 'b--', t, Ud(:,12), 'k--', 'LineWidth', 1.2);
title('Control Forces (Fz)', 'FontSize', 20)
xlabel('Time [s]', 'Interpreter', 'latex', 'FontSize', 14)
...
legend({'$U_2$ leg 1', '$U_2$ leg 2', '$U_2$ leg 3', '$U_2$ leg 4', ...
       ...
       'Interpreter', 'latex', 'FontSize', 12, 'Location', 'northeast');
exportgraphics(fig4, fullfile('plot_ex3', 'forces.pdf'));
